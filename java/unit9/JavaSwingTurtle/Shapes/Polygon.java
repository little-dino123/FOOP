...
public class Polygon {
    ...
    public Polygon(Turtle it, int isides, int isize, Color icolor, int icenterX, int icenterY){
        t = it;
        sides = isides;
        size = isize;
        color = icolor;
    ...
    public Polygon(Turtle it, int isides,int isize){
        this(it,isides, isize,Color.BLACK);
    }
    public Polygon(Turtle it,int isides,int isize, Color icolor){
